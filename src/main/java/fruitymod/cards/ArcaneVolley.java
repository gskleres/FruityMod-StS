...
extends CustomCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        for (AbstractMonster mo : AbstractDungeon.getCurrRoom().monsters.monsters) {
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(mo, p, new WeakPower(mo, this.magicNumber, false), 1, true, AbstractGameAction.AttackEffect.NONE));
        }
    }
