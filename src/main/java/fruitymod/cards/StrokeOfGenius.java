...
public class StrokeOfGenius extends CustomCard implements ModalChoice.Callback
{
    ...
    {
        super(ID, NAME, FruityMod.makePath(FruityMod.STROKE_OF_GENIUS), COST, DESCRIPTION, CardType.SKILL, AbstractCardEnum.SEEKER_PURPLE, CardRarity.UNCOMMON, CardTarget.NONE);
