...
public class Brainstorm extends CustomCard {
	...
	public static final String UPGRADE_DESCRIPTON = cardStrings.UPGRADE_DESCRIPTION;
    private static final int COST = 0;
    private static final int DRAW = 1;
    private static final int DRAW_UPGRADE = 2;
    ...
    public void upgrade() {
        if (!this.upgraded) {
            ...
            this.rawDescription = UPGRADE_DESCRIPTON;
