...
import fruitymod.seeker.powers.PremonitionsPower;

public class Premonitions extends CustomCard {
    public static final String ID = "Premonitions";
